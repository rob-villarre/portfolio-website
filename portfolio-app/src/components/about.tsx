...
class About extends React.Component {
  render() {
    return (
    <section id='about'>
      <div className='min-vh-100 py-5 container-fluid'>
        <div className="py-4">
          ...
          <p className='text-white-50'>
            ...
            On this website, you will find a selection of my projects and experiences that showcase my skills and abilities as an aspiring software engineer.
